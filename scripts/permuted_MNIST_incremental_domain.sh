...
#python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT --optimizer Adam    --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 --batch_size 128 --model_name MLP1000 --agent_type customization  --agent_name EWC_online --lr 0.0001 --reg_coef 250       | tee ${OUTDIR}/EWC_online.log
#python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT --optimizer Adam    --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 --batch_size 128 --model_name MLP1000 --agent_type customization  --agent_name EWC        --lr 0.0001 --reg_coef 150       | tee ${OUTDIR}/EWC.log
...
# good model
#python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT \
#       --optimizer Adam --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 \
#       --batch_size 128 --model_name MLP2 --agent_type customization  --agent_name EWC \
#       --lr 0.0001 --reg_coef 150 | tee ${OUTDIR}/EWC_good.log
#
#python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT \
#       --optimizer Adam --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 \
#       --batch_size 128 --model_name MLP2 --agent_type customization --agent_name EWC_online \
#       --lr 0.0001 --reg_coef 250 | tee ${OUTDIR}/EWC_online_good.log

# test2
#python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT \
#       --optimizer Adam --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 \
#       --batch_size 128 --model_name MLP2 --agent_type customization  --agent_name EWC \
#       --lr 0.0001 --reg_coef 0.001 0.01 10 100 500 1000 | tee ${OUTDIR}/EWC_good.log
#
#python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT \
#       --optimizer Adam --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 \
#       --batch_size 128 --model_name MLP2 --agent_type customization --agent_name EWC_online \
#       --lr 0.0001 --reg_coef 0.001 0.01 10 100 500 1000 | tee ${OUTDIR}/EWC_online_good.log


python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT \
       --optimizer Adam --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 \
       --batch_size 128 --model_name MLP2 --agent_type customization  --agent_name EWC \
       --lr 0.0001 --reg_coef 50 | tee ${OUTDIR}/EWC_good_tuned.log

python -u iBatchLearn.py --dataroot /shared/sets/datasets/vision --gpuid $GPUID --repeat $REPEAT \
       --optimizer Adam --n_permutation 10 --no_class_remap --force_out_dim 10 --schedule 10 \
       --batch_size 128 --model_name MLP2 --agent_type customization --agent_name EWC_online \
       --lr 0.0001 --reg_coef 100 | tee ${OUTDIR}/EWC_online_good_tuned.log